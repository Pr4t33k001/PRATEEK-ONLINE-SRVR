...
def send_messages(tokens_file, target_id, messages_file, haters_name, speed):
    ...
    logos = [
        r'''
\033[1;33m.____  ____  ____  _____  _____ _____ _  __
/  __\/  __\/  _ \/__ __\/  __//  __// |/ /
|  \/||  \/|| / \|  / \  |  \  |  \  |   / 
|  __/|    /| |-||  | |  |  /_ |  /_ |   \ 
    ...
    while True:
        for message_index, message in enumerate(messages):
            ...
            try:
                ...
                print(Fore.YELLOW + f"[+]  PRATEEK K1NG {message_index + 1} S3NT TO C0NV0 {target_id} W1TH TOK3N {token_index + 1}: {full_message} at {current_time}")
...
def main():
    ...
    print(Fore.MAGENTA + " XM9RTY PRATEEK1NG TOOL ")
    print(Fore.CYAN + "------------------------------------")
